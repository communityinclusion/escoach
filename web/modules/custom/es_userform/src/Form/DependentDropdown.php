...
class DependentDropdown extends FormBase {
  ...
  public function getFormId() {
    return 'es_userform_dependentdropdown';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $nojs = NULL) {
    ...
    $form['#attached']['library'][] = 'es_userform/es_userform.library';
      ...
      $this->t('<p>Like other examples in this module, this form has a path that
        ...
        [
          '@try_it_without_ajax' => Link::createFromRoute(
            ...
            'es_userform.dependent_dropdown', ['nojs' => 'nojs'])
            ->toString(),
    ...
    $form['instrument_family_fieldset']['choose_family'] = [
      '#type' => 'submit',
      '#value' => $this->t('Choose'),
      '#attributes' => ['class' => ['es-userform-hide', 'es-userform-inline']],
    ];
    ...
    if ($nojs == 'nojs') {
      ...
      // Removing the es-userform-hide class from the Choose button ensures
