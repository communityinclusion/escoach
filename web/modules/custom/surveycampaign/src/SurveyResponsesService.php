                ...
                foreach($output['data'] as $response) {
                    ...
                    if($checkexisting < 1){
                       // \Drupal::logger('surveycampaign alert')->notice('Survey id: ' . $surveyid);
                        ...
                        if($surveyid == '5420562') {
                            $answer482 = array_key_exists('answer_id', $response['survey_data'][482]) && $response['survey_data'][482]['answer_id']  ? $response['survey_data'][482]['answer_id'] : NULL;
                            $answer481 = array_key_exists('answer_id', $response['survey_data'][481]) && $response['survey_data'][481]['answer_id'] ? $response['survey_data'][481]['answer_id'] : NULL;
                            $answer525 =  array_key_exists('answer_id', $response['survey_data'][525]) && $response['survey_data'][525]['answer_id'] ? $response['survey_data'][525]['answer_id'] : NULL;
                            $answer526 = array_key_exists('answer_id', $response['survey_data'][526]) && $response['survey_data'][526]['answer_id'] ? $response['survey_data'][526]['answer_id'] : NULL;
                            $answer590 = array_key_exists('answer_id', $response['survey_data'][590]) && $response['survey_data'][590]['answer_id'] ? $response['survey_data'][590]['answer_id'] : NULL;
                            $answer591 = array_key_exists('answer_id', $response['survey_data'][591]) && $response['survey_data'][591]['answer_id']  ? $response['survey_data'][591]['answer_id'] : NULL;
                            $answer592 = array_key_exists('answer_id', $response['survey_data'][592]) && $response['survey_data'][592]['answer_id'] ? $response['survey_data'][592]['answer_id'] : NULL;
                            $answer483 = array_key_exists('answer_id', $response['survey_data'][483]) && $response['survey_data'][483]['answer_id'] ? $response['survey_data'][483]['answer_id'] : NULL;
                            $answer537 = array_key_exists('answer_id', $response['survey_data'][537]) && $response['survey_data'][537]['answer_id'] ? $response['survey_data'][537]['answer_id'] : NULL;
                            $answer538 = array_key_exists('answer_id', $response['survey_data'][538]) && $response['survey_data'][538]['answer_id'] ? $response['survey_data'][538]['answer_id'] : NULL;
                            $answer539 = array_key_exists('answer_id', $response['survey_data'][539]) && $response['survey_data'][539]['answer_id'] ? $response['survey_data'][539]['answer_id'] : NULL;
                            $answer540 = array_key_exists('answer_id', $response['survey_data'][540]) && $response['survey_data'][540]['answer_id'] ? $response['survey_data'][540]['answer_id'] : NULL;
                            $answer541 = array_key_exists('answer_id', $response['survey_data'][541]) && $response['survey_data'][541]['answer_id'] ? $response['survey_data'][541]['answer_id'] : NULL;
                            $answer542 = array_key_exists('answer_id', $response['survey_data'][542]) && $response['survey_data'][542]['answer_id'] ? $response['survey_data'][542]['answer_id'] : NULL;
                        }
