    ...
    protected function checkSuspendedReminder($mobilephone,$fullname,$surveyid) {
      ...
      */
      ...
      $cancelled = \Drupal::service('surveycampaign.survey_users')->checkCancelled($mobilephone);
       \Drupal::logger('surveycampaign')->notice("$fullname Last campaignid: $result2 Count campaigns since last: $comparenumber Days pastinactive setting: $dayspastinactive Cancel if reach this inactive number: $finalcanceldays");
